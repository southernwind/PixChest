...
public class SortManagerViewModel : ViewModelBase {
	...
	/// ソート条件
	/// </summary>
	public Reactive.Bindings.ReactiveCollection<SortConditionEditorViewModel> SortConditions {
		get;
	} = [];
	...
	public void Load() {
		...
		this.SortConditions.AddRange(Reactive.Bindings.ReadOnlyReactiveCollection.ToReadOnlyReactiveCollection(this._sortManager.SortConditions, x => new SortConditionEditorViewModel(x)));
