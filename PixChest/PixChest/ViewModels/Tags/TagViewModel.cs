...
public class TagViewModel : ViewModelBase {
	public TagViewModel(Tag tag, TagsManager tagsManager) {
		...
		this.UpdateTagCommand.Subscribe(async _ => await tagsManager.UpdateTag(tag.TagId, this.TagName.Value, this.Detail.Value, this.TagAliases.Select(x => x.Alias.Value)));
